...
begin
  ...
  -- invite-only: uninvited signups are rejected (first user excepted)
...
-- Super admin can delete accounts (cascades to profile/keys/memberships).
...
-- ============ MIGRATION 007 CONTENT (creator-only moves + audit) ============
